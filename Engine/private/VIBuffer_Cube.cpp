...
HRESULT CVIBuffer_Cube::NativeConstruct_Prototype()
{
	...
	{
		MSGBOX("__super::Create_VertexBuffer returned E_FAIL in CVIBuffer_Cube::NativeConstruct_Prototype");
		return E_FAIL;
	}
	...
	{
		MSGBOX("__super::Create_IndexBuffer returned E_FAIL in CVIBuffer_Cube::NativeConstruct_Prototype");
		return E_FAIL;
	}
...
void CVIBuffer_Cube::MakeHitBox(CCollider_Sphere::SPHEREDESC tSphereDesc)
{
	...
	pVertices[0].vPosition = _float3(-tSphereDesc.fRadius, tSphereDesc.fRadius, -tSphereDesc.fRadius) + tSphereDesc.fDist_From_Obj;

	pVertices[1].vPosition = _float3(tSphereDesc.fRadius, tSphereDesc.fRadius, -tSphereDesc.fRadius) + tSphereDesc.fDist_From_Obj;

	pVertices[2].vPosition = _float3(tSphereDesc.fRadius, -tSphereDesc.fRadius, -tSphereDesc.fRadius) + tSphereDesc.fDist_From_Obj;

	pVertices[3].vPosition = _float3(-tSphereDesc.fRadius, -tSphereDesc.fRadius, -tSphereDesc.fRadius) + tSphereDesc.fDist_From_Obj;

	pVertices[4].vPosition = _float3(-tSphereDesc.fRadius, tSphereDesc.fRadius, tSphereDesc.fRadius) + tSphereDesc.fDist_From_Obj;

	pVertices[5].vPosition = _float3(tSphereDesc.fRadius, tSphereDesc.fRadius, tSphereDesc.fRadius) + tSphereDesc.fDist_From_Obj;

	pVertices[6].vPosition = _float3(tSphereDesc.fRadius, -tSphereDesc.fRadius, tSphereDesc.fRadius) + tSphereDesc.fDist_From_Obj;

	pVertices[7].vPosition = _float3(-tSphereDesc.fRadius, -tSphereDesc.fRadius, tSphereDesc.fRadius) + tSphereDesc.fDist_From_Obj;

	m_pVB->Unlock();
}

void CVIBuffer_Cube::BaseSetting()
{
...
CVIBuffer_Cube * CVIBuffer_Cube::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	...
	{
		MSGBOX("Failed to Create CVIBuffer_Cube in CVIBuffer_Cube::Create");
...
CComponent * CVIBuffer_Cube::Clone(void * pArg)
{
	...
	{
		MSGBOX("Failed to Create CVIBuffer_Cube in CVIBuffer_Cube::Clone");
		Safe_Release(pInstance);
	}
