...
class CEndDoorRight final : public CGameObject
{
public:
	explicit CEndDoorRight(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CEndDoorRight(const CEndDoorRight& rhs);
	virtual ~CEndDoorRight() = default;
...
public:
	static	CEndDoorRight*			Create(LPDIRECT3DDEVICE9 pGraphic_Device);
