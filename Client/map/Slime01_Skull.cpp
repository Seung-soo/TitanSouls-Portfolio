...
CSlime01_Skull::CSlime01_Skull(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{
}

CSlime01_Skull::CSlime01_Skull(const CSlime01_Skull & rhs)
	: CGameObject(rhs)
{
}

HRESULT CSlime01_Skull::NativeConstruct_Prototype()
{
...
HRESULT CSlime01_Skull::NativeConstruct(void * pArg)
{
...
_int CSlime01_Skull::Tick(_float fTimeDelta)
{
...
_int CSlime01_Skull::LateTick(_float fTimeDelta)
{
...
HRESULT CSlime01_Skull::SetUp_Components()
{
	...
	if (FAILED(__super::Add_Component(LEVEL_SLIME, TEXT("Prototype_Component_Texture_Skull_Slime01"), TEXT("Com_Texture"), (CComponent**)&m_pTextureCom)))
	{
...
HRESULT CSlime01_Skull::SetUp_RenderState()
{
...
HRESULT CSlime01_Skull::Release_RenderState()
{
...
CSlime01_Skull * CSlime01_Skull::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CSlime01_Skull*	pInstance = new CSlime01_Skull(pGraphic_Device);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Create CSlime01_Skull in CSlime01_Skull::Create");
...
CGameObject * CSlime01_Skull::Clone(void * pArg)
{
	CSlime01_Skull*	pInstance = new CSlime01_Skull(*this);

	if (FAILED(pInstance->NativeConstruct(pArg)))
	{
		MSGBOX("Failed to Create CSlime01_Skull in CSlime01_Skull::Clone");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CSlime01_Skull::Free()
{
	__super::Free();
