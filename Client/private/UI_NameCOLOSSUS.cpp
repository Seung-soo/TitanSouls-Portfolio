#include "stdafx.h"
#include "..\public\UI_NameCOLOSSUS.h"
#include "GameInstance.h"

CUI_NameCOLOSUSS::CUI_NameCOLOSUSS(LPDIRECT3DDEVICE9 pGraphic_Device)
	:CAlphaUI(pGraphic_Device)
{
}

CUI_NameCOLOSUSS::CUI_NameCOLOSUSS(const CUI_NameCOLOSUSS & rhs)
	: CAlphaUI(rhs)
{
}

HRESULT CUI_NameCOLOSUSS::NativeConstruct_Prototype()
{
	return __super::NativeConstruct_Prototype();
}

HRESULT CUI_NameCOLOSUSS::NativeConstruct(void * pArg)
{
...
_int CUI_NameCOLOSUSS::Tick(_float fTimeDelta)
{
	m_fSpriteSpeed = 1.f;
...
_int CUI_NameCOLOSUSS::LateTick(_float fTimeDelta)
{
	return __super::LateTick(fTimeDelta);
}

HRESULT CUI_NameCOLOSUSS::Render()
{
...
HRESULT CUI_NameCOLOSUSS::SetUp_Components()
{
...
HRESULT CUI_NameCOLOSUSS::Go_Sprites(void)
{
...
CUI_NameCOLOSUSS * CUI_NameCOLOSUSS::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CUI_NameCOLOSUSS*	pInstance = new CUI_NameCOLOSUSS(pGraphic_Device);
...
CGameObject * CUI_NameCOLOSUSS::Clone(void * pArg)
{
	CGameObject*	pInstance = new CUI_NameCOLOSUSS(*this);
...
void CUI_NameCOLOSUSS::Free(void)
{
	__super::Free();
