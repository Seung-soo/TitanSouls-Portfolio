...
#include "..\public\UI_NameEYECUBE.h"
#include "GameInstance.h"

CUI_NameEYECUBE::CUI_NameEYECUBE(LPDIRECT3DDEVICE9 pGraphic_Device)
	:CAlphaUI(pGraphic_Device)
{
}

CUI_NameEYECUBE::CUI_NameEYECUBE(const CUI_NameEYECUBE & rhs)
	: CAlphaUI(rhs)
{
}

HRESULT CUI_NameEYECUBE::NativeConstruct_Prototype()
{
	return __super::NativeConstruct_Prototype();
}

HRESULT CUI_NameEYECUBE::NativeConstruct(void * pArg)
{
...
_int CUI_NameEYECUBE::Tick(_float fTimeDelta)
{
	m_fSpriteSpeed = 1.f;
...
_int CUI_NameEYECUBE::LateTick(_float fTimeDelta)
{
	return __super::LateTick(fTimeDelta);
}

HRESULT CUI_NameEYECUBE::Render()
{
...
HRESULT CUI_NameEYECUBE::SetUp_Components()
{
...
HRESULT CUI_NameEYECUBE::Go_Sprites(void)
{
...
CUI_NameEYECUBE * CUI_NameEYECUBE::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CUI_NameEYECUBE*	pInstance = new CUI_NameEYECUBE(pGraphic_Device);
...
CGameObject * CUI_NameEYECUBE::Clone(void * pArg)
{
	CGameObject*	pInstance = new CUI_NameEYECUBE(*this);
...
void CUI_NameEYECUBE::Free(void)
{
	__super::Free();
