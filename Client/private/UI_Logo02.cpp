#include "stdafx.h"
#include "..\public\UI_Logo02.h"
#include "GameInstance.h"
#include "Level_Loading.h"
CUI_Logo02::CUI_Logo02(LPDIRECT3DDEVICE9 pGraphic_Device)
	:CAlphaUI(pGraphic_Device)
{
}

CUI_Logo02::CUI_Logo02(const CUI_Logo02 & rhs)
	: CAlphaUI(rhs)
{
}

HRESULT CUI_Logo02::NativeConstruct_Prototype()
{
	return __super::NativeConstruct_Prototype();
}

HRESULT CUI_Logo02::NativeConstruct(void * pArg)
{
...
_int CUI_Logo02::Tick(_float fTimeDelta)
{
	if (!m_bEnd){
		if (!m_bOff) {
			m_iAlpha += 3;
...
_int CUI_Logo02::LateTick(_float fTimeDelta)
{

	return __super::LateTick(fTimeDelta);
}

HRESULT CUI_Logo02::Render()
{
...
HRESULT CUI_Logo02::SetUp_Components()
{
	...
	/* For.Com_Texture */
	//사본 텍스쳐 컴포넌트
	if (FAILED(__super::Add_Component(LEVEL_LOGO, TEXT("Prototype_Component_Texture_LogoUI02"), TEXT("Com_Texture"), (CComponent**)&m_pTextureCom)))
	{
		return E_FAIL;
	}
	return S_OK;
}
HRESULT CUI_Logo02::SetUp_RenderState()
{
...
CUI_Logo02 * CUI_Logo02::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CUI_Logo02*	pInstance = new CUI_Logo02(pGraphic_Device);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Create Logo in CUI_Logo02::Create");
...
CGameObject * CUI_Logo02::Clone(void * pArg)
{
	CGameObject*	pInstance = new CUI_Logo02(*this);

	if (FAILED(pInstance->NativeConstruct(pArg)))
	{
		MSGBOX("Failed to Create Logo in CUI_Logo02::Clone");
		Safe_Release(pInstance);
	}
