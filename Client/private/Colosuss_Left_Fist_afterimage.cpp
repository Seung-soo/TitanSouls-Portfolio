#include "stdafx.h"
#include "..\Public\Colosuss_Left_Fist_afterimage.h"
#include "GameInstance.h"

CColosuss_Left_Fist_afterimage::CColosuss_Left_Fist_afterimage(LPDIRECT3DDEVICE9 pGraphic_Device)
	: CGameObject(pGraphic_Device)
{

}

CColosuss_Left_Fist_afterimage::CColosuss_Left_Fist_afterimage(const CColosuss_Left_Fist_afterimage& rhs)
	: CGameObject(rhs)
{
}

HRESULT CColosuss_Left_Fist_afterimage::NativeConstruct_Prototype()
{
...
HRESULT CColosuss_Left_Fist_afterimage::NativeConstruct(void * pArg)
{
...
_int CColosuss_Left_Fist_afterimage::Tick(_float fTimeDelta)
{
...
_int CColosuss_Left_Fist_afterimage::LateTick(_float fTimeDelta)
{
	if (0 > __super::LateTick(fTimeDelta))
	{
		MSGBOX("0 > __super::LateTick in CColosuss_Left_Fist_afterimage::LateTick");
		return -1;
	}

	if (nullptr == m_pRendererCom)
	{
		MSGBOX("m_pRendererCom is nullptr in CColosuss_Left_Fist_afterimage::LateTick");
		return -1;
	}
...
HRESULT CColosuss_Left_Fist_afterimage::Render()
{
	if (nullptr == m_pVIBufferCom)
	{
		MSGBOX("m_pVIBufferCom is nullptr in CColosuss_Left_Fist_afterimage::Render")
			return E_FAIL;
	}

	if (FAILED(m_pTransformCom->Bind_OnGraphicDevice()))
	{
		MSGBOX("m_pTransformCom->Bind_OnGraphicDevice returned E_FAIL in CColosuss_Left_Fist_afterimage::Render");
		return E_FAIL;
	}
...
HRESULT CColosuss_Left_Fist_afterimage::Go_Sprites()
{
...
HRESULT CColosuss_Left_Fist_afterimage::SetUp_Components()
{
	/* For.Com_Transform */
	...
	{
		MSGBOX("__super::Add_Component returned E_FAIL in CColosuss_Left_Fist_afterimage::SetUp_Components(Transform)");
		return E_FAIL;
	}

	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_Renderer"), TEXT("Com_Renderer"), (CComponent**)&m_pRendererCom)))
	{
		MSGBOX("__super::Add_Component returned E_FAIL in CColosuss_Left_Fist_afterimage::SetUp_Components(Renderer)");
		return E_FAIL;
	}

	if (FAILED(__super::Add_Component(LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Rect"), TEXT("Com_VIBuffer"), (CComponent**)&m_pVIBufferCom)))
	{
		MSGBOX("__super::Add_Component returned E_FAIL in CColosuss_Left_Fist_afterimage::SetUp_Components(VIBuffer_Rect)");
		return E_FAIL;
	}
...
HRESULT CColosuss_Left_Fist_afterimage::SetUp_OnTerrain()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
HRESULT CColosuss_Left_Fist_afterimage::SetUp_RenderState()
{
...
HRESULT CColosuss_Left_Fist_afterimage::Release_RenderState()
{
	if (nullptr == m_pGraphic_Device)
		return E_FAIL;
...
CColosuss_Left_Fist_afterimage* CColosuss_Left_Fist_afterimage::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CColosuss_Left_Fist_afterimage*	pInstance = new CColosuss_Left_Fist_afterimage(pGraphic_Device);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSGBOX("Failed to Creating CColosuss_Left_Fist_afterimage");
...
CGameObject * CColosuss_Left_Fist_afterimage::Clone(void* pArg)
{
	/* 새로운객체를 복제하여 생성한다. */
	CColosuss_Left_Fist_afterimage*	pInstance = new CColosuss_Left_Fist_afterimage(*this);
...
void CColosuss_Left_Fist_afterimage::Free()
{
	__super::Free();
