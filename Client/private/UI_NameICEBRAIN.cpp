#include "stdafx.h"
#include "..\public\UI_NameICEBRAIN.h"
#include "GameInstance.h"

CUI_NameICEBRAIN::CUI_NameICEBRAIN(LPDIRECT3DDEVICE9 pGraphic_Device)
	:CAlphaUI(pGraphic_Device)
{
}

CUI_NameICEBRAIN::CUI_NameICEBRAIN(const CUI_NameICEBRAIN & rhs)
	: CAlphaUI(rhs)
{
}

HRESULT CUI_NameICEBRAIN::NativeConstruct_Prototype()
{
	return __super::NativeConstruct_Prototype();
}

HRESULT CUI_NameICEBRAIN::NativeConstruct(void * pArg)
{
...
_int CUI_NameICEBRAIN::Tick(_float fTimeDelta)
{
	m_fSpriteSpeed = 1.f;
...
_int CUI_NameICEBRAIN::LateTick(_float fTimeDelta)
{
	return __super::LateTick(fTimeDelta);
}

HRESULT CUI_NameICEBRAIN::Render()
{
...
HRESULT CUI_NameICEBRAIN::SetUp_Components()
{
...
HRESULT CUI_NameICEBRAIN::Go_Sprites(void)
{
...
CUI_NameICEBRAIN * CUI_NameICEBRAIN::Create(LPDIRECT3DDEVICE9 pGraphic_Device)
{
	CUI_NameICEBRAIN*	pInstance = new CUI_NameICEBRAIN(pGraphic_Device);
...
CGameObject * CUI_NameICEBRAIN::Clone(void * pArg)
{
	CGameObject*	pInstance = new CUI_NameICEBRAIN(*this);
...
void CUI_NameICEBRAIN::Free(void)
{
	__super::Free();
