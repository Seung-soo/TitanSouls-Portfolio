...
class CMonster_Short_Range final : public CGameObject
{
private:
	explicit CMonster_Short_Range(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CMonster_Short_Range(const CMonster_Short_Range& rhs);
	virtual ~CMonster_Short_Range() = default;
public:
...
private:
	...
	void	Collision_Rect();
public:
	static CMonster_Short_Range* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
