...
class CLevel_Respawn1 final : public CLevel
{
public:
	explicit CLevel_Respawn1(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CLevel_Respawn1() = default;
public:
...
public:
	static	CLevel_Respawn1*	Create(LPDIRECT3DDEVICE9 pGraphic_Device);
