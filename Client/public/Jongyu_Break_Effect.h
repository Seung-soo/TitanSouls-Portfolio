...
class CJongyu_Break_Effect final : public CGameObject
{
private:
	explicit CJongyu_Break_Effect(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CJongyu_Break_Effect(const CJongyu_Break_Effect& rhs);
	virtual ~CJongyu_Break_Effect() = default;
public:
...
private:
	...
	//void	Collision_Rect();
public:
	static CJongyu_Break_Effect* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
