...
class CSlime_water_mini final : public CGameObject
{
private:
	explicit CSlime_water_mini(LPDIRECT3DDEVICE9 pGraphic_Device);
	explicit CSlime_water_mini(const CSlime_water_mini& rhs);
	virtual ~CSlime_water_mini() = default;
public:
...
private:
	...
	//void	Collision_Rect();
public:
	static CSlime_water_mini* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
